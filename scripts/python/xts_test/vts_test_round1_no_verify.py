...
run_command = '/home/amlogic/Desktop/android-vts/tools/vts-tradefed run vts -s vts00000665\n'
retry_command_regu = '/home/amlogic/Desktop/android-vts/tools/vts-tradefed run retry --retry {} -s vts00000665\n'
...
def check_wifi_connection():
    wifi_status = subprocess.getoutput("adb -s vts00000665 shell cmd wifi status")
    if "Wifi is connected to \"openwrt_5g\"" in wifi_status:
        return True
    else:
...
if __name__ == '__main__':
    ...
    while count < MAX_RETRY:
        ...
        result_info = subprocess.check_output('/home/amlogic/Desktop/android-vts/tools/vts-tradefed l r'.split(),
                                              encoding='utf-8')
        print(result_info)
        ...
        if not check_wifi_connection():
            os.system("adb -s vts00000665 shell cmd wifi set-wifi-enabled enabled")
            os.system("adb -s vts00000665 shell cmd wifi connect-network openwrt_5g wpa2 1234567890")
            time.sleep(10)
