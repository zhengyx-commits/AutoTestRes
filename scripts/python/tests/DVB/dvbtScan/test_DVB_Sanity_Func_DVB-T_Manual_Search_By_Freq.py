...
# @Time    : 2023/2/22
# @Author  : kejun.chen
# @File    : test_DVB_Sanity_Func_DVB-T_Manual_Search_By_Freq.py
...
scan_param = [
    ...
    {"No": "2", "video_name": "MPEG2_1_Service", "scan_format": "DVB-T", "band_width": "8", "fft_size": "8k",
     "mode": "64QPSK", "freq": "177.5", "G_I": "1/16", "code_rate": "7/8"}]
...
for t in scan_param:
    ...
    # new_scan_param = f'Task{t["No"]}({t["video_name"]}, {t["scan_format"]}, {t["freq"]}, {parameter}, {t["band_width"]}, {t["fft_size"]})'
    task_dict = {
        "No": t["No"],
...
task_ids = ['Task{}({}, {}, {}, {}, {}, {}'.format(
    t["No"], t["video_name"], t["scan_format"], t["freq"], t["parameters"], t["band_width"], t["fft_size"]) for t in scan_params]
...
def test_dvb_scan(param):
    ...
    dvb.dvbt_manual_scan_by_freq(bandwidth=param["band_width"], mode=param["fft_size"], dvbtype='DVB-T', freq=str(int(float(param["freq"])) * 1000))
    assert dvb_check.check_dvbt_manual_scan_by_freq()
