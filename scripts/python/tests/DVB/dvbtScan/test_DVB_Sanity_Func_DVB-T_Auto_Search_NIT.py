...
# @Time    : 2023/3/2
# @Author  : kejun.chen
# @File    : test_DVB_Sanity_Func_DVB-T_Auto_Search_NIT.py.py
...
scan_param = [
    {"No": "1", "video_name": "MPEG2_1_Service", "scan_format": "DVB-T", "band_width": "8", "fft_size": "2k",
     "mode": "64QPSK", "freq": "474", "G_I": "1/4", "code_rate": "1/2", "nit": "true"},
    {"No": "2", "video_name": "MPEG2_1_Service", "scan_format": "DVB-T", "band_width": "8", "fft_size": "2k",
     "mode": "64QPSK", "freq": "474", "G_I": "1/4", "code_rate": "1/2", "nit": "false"},
    {"No": "3", "video_name": "MPEG2_1_Service", "scan_format": "DVB-T", "band_width": "8", "fft_size": "2k",
     "mode": "64QPSK", "freq": "474", "G_I": "1/4", "code_rate": "1/2", "nit": "true"}]
...
for t in scan_param:
    ...
    # new_scan_param = f'Task{t["No"]}({t["video_name"]}, {t["scan_format"]}, {t["freq"]}, {parameter}, {t["nit"]})'
    task_dict = {
        "No": t["No"],
...
task_ids = ['Task{}({}, {}, {}, {}, {}'.format(
    t["No"], t["video_name"], t["scan_format"], t["freq"], t["parameters"], t["nit"]) for t in scan_params]
...
def test_dvb_scan(param):
    ...
    dvb.dvbt_auto_scan(nit=param["nit"])
