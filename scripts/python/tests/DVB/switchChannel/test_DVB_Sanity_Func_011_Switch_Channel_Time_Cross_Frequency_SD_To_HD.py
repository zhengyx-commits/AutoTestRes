...
# @Time    : 2022/6/30
# @Author  : kejun.chen
# @File    : test_DVB_Sanity_Func_Switch_Channel_Time_Cross_Frequency_SD_To_HD.py
...
p_conf_switch_channel_time = p_conf_dvb['cross_fre_sd_to_hd_time']


@pytest.fixture(scope='function', autouse=True)
def dvb_setup_teardown():
    dvb_stream.start_dvbc_multi_stream_diff_frq(0, 'ts', 'gr1', 'TRT_4K')
