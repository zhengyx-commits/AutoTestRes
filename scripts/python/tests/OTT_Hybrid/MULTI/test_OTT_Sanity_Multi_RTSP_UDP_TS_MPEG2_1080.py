...
def test_RTSP_UDP_TS_MPEG2_1080():
    ...
    if single_stream:
        stream_name_list, url = get_conf_url("conf_rtsp_url", "rtsp_TS_MPEG2_1080", "conf_stream_name",
                                             "mpeg2_1080I_30FPS")
        file_path = streamProvider.get_file_path('mpeg2_1080I_30FPS', 'ts', stream_name_list[0])
        if len(file_path) >= 1:
        ...
        stream_name_list = get_conf_url("conf_rtsp_url", "rtsp_TS_MPEG2_1080")
