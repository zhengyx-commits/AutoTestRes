...
def test_Multi_FOUR_SCREEN_HLSV3_1080P():
    hlsV3_TS_H264_1080_urls = get_conf_url("conf_hls_url", "hlsV3_TS_H264_1080")
    hlsV3_TS_H264_4K_urls = get_conf_url("conf_hls_url", "hlsV3_TS_H264_1080")
    if len(hlsV3_TS_H264_1080_urls) != 0 and len(hlsV3_TS_H264_4K_urls) != 0:
        urls = list(itertools.product(hlsV3_TS_H264_1080_urls, hlsV3_TS_H264_4K_urls))
        # new_url_list = hlsV3_TS_H265_1080_urls + hlsV3_TS_H265_4K_urls
        # print(f"urls: {urls}")
        for url in urls:
            url = list(url)
