...
@pytest.mark.skip
def test_HLSV5_TS_H265_4k():
    final_urllist = get_conf_url("conf_hls_url", "hlsV5_TS_H265_4K")
    for item in final_urllist:
        ...
        assert playerCheck.check_speed(fb_cmd_1, 0.5, 30), "playback fb-0.5x speed failed"
