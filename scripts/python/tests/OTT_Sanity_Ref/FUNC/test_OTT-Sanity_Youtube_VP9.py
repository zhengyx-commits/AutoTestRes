...
@pytest.mark.parametrize("video", [p_conf_ref_video])
def test_youtube_vp9(video):
    # # init youtube
    ...
    playback_format = "VP9"
    youtube.VIDEO_TAG_LIST[0]["link"] = video
    youtube.youtube_playback(playback_format, seekcheck=p_conf_seek_check)
    youtube.stop_youtube()
