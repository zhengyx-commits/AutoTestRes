...
# @Time    : 2023/3/16 下午14:00
# @Author  : jun.yang
# @Site    :
# @File    : test_OTT-Sanity_GooglePlayMovies_HomePlay.py
# @Software: PyCharm
import time
import pytest
import logging
...
def test_google_play_home():
    ...
    playback_type = None
    playmovies.run_googleplaymovies(playback_type, home_able=True)
    playmovies.home()
    playmovies.app_stop(playmovies.PLAYER_PACKAGE_TUPLE[0])
