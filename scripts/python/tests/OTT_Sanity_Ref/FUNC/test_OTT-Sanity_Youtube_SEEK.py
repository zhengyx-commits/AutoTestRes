...
# @author     : jun.yang
# @software   : PyCharm
# @file       : test_OTT-Sanity_Youtube_SEEK.py
...
def test_youtube_seek():
    ...
    p_conf_seek_check = True
    assert youtube.youtube_playback(playback_format, seekcheck=p_conf_seek_check)[0]
