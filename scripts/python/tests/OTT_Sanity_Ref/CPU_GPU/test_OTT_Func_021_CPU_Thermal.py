...
import pytest
import logging
from tests.OTT_Sanity_Ref import config_ott_sanity_yaml, adb

p_conf_cpu_thermal = config_ott_sanity_yaml.get_note('conf_cpu_thermal')
...
class TestOTTCPUTHERMAL:
    ...
    def test_021_cpu_thermal_mode(self):
    ...
    def test_021_cpu_thermal(self):
        actual_thermal = adb.run_shell_cmd(cpu.CPU_TEMPERATURE_COMMAND)[1]
