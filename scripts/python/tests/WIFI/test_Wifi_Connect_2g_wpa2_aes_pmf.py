...
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_Connect_2g_wpa2_aes_pmf.py
# @Software: PyCharm
...
wifi = WifiTestApk()
p_conf_router_info = yamlTool(os.getcwd() + '/config/config_wifi.yaml').get_note('conf_connect_2g_wpa2_aes_pmf')
...
def test_connect_wpa2_aes_pmf_ssid():
