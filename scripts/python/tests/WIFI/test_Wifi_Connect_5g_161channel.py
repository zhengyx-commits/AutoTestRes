...
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_Connect_5g_161channel.py
# @Software: PyCharm
...
'''
测试配置
1.设置路由器5G 无线网络名称为“ATC_ASUS_AX88U_5G”，隐藏SSID设置为否，无线模式设置为自动，频道带宽设置为80M,信道设置为149，授权方式为open
2.连接5G SSID
...
wifi = WifiTestApk()
p_conf_router_info = yamlTool(os.getcwd() + '/config/config_wifi.yaml').get_note('conf_connect_5g_161_channel')
