...
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_Connect_5g_80mhz.py
# @Software: PyCharm
...
wifi = WifiTestApk()
p_conf_router_info = yamlTool(os.getcwd() + '/config/config_wifi.yaml').get_note('conf_connect_5g_80mhz')
