...
#define LIBDAQ_API_VERSION 0x020600  //2.6.0
...
DLL_API int DLL_CALL libdaq_device_get_status(const char * device_name);
...
DLL_API int DLL_CALL libdaq_adc_read_binary(const char* deviceName,const char *module_name, int *databuf, unsigned int datalen, unsigned int *actuallen);
