...
if(platform.system()=='Windows'):
    ...
    if (platform.machine() == 'x86_64'):
        dll_path = os.path.join("/home/amlogic/AutoTestRes/scripts/python/lib/common/tools/HW/DAQ/daqlib/linux_x86_64/libdaqlib.so.1.0.0")
    elif (platform.machine() == 'arm32'):
        dll_path = os.path.join(dir,'daqlib/linux_arm32/libdaqlib.so.1.0.0')
    elif (platform.machine() == 'arm64'):
        dll_path = os.path.join(dir,'daqlib/linux_arm64/libdaqlib.so.1.0.0')
else:
